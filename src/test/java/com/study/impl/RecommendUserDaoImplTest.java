...
public class RecommendUserDaoImplTest {
	...
	public void setUp()
	{
		DaoManager daoManager = new DaoManager(TestDB.h2DataSource(),TestDB.h2DataSource());
    ...
    public void updateBatch() throws Exception {
        ...
        List<RecommendUser> users = ImmutableList.of(
            new RecommendUser(6, 6), new RecommendUser(7, 7), new RecommendUser(1, 4)
        );
